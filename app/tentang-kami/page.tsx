  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#081225] pb-10">
      ...
      <div className="px-5 mt-6 space-y-6">
        ...
        {/* Profile Card */}
        <div className="bg-white/[0.08] backdrop-blur-md rounded-3xl p-6 border border-white/12 shadow-sm relative overflow-hidden">
          ...
          <p className="text-xs text-blue-400 font-extrabold uppercase tracking-widest mb-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          {/* Cepat */}
          <div className="bg-white/[0.08] rounded-2xl p-4 border border-white/12 shadow-sm">
            <div className="w-9 h-9 bg-blue-500/20 text-blue-400 border border-blue-500/30 rounded-xl flex items-center justify-center mb-3">
          ...
          {/* Hemat */}
          <div className="bg-white/[0.08] rounded-2xl p-4 border border-white/12 shadow-sm">
            <div className="w-9 h-9 bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 rounded-xl flex items-center justify-center mb-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
          ...
          {/* Lengkap */}
          <div className="bg-white/[0.08] rounded-2xl p-4 border border-white/12 shadow-sm">
            <div className="w-9 h-9 bg-sky-500/20 text-sky-400 border border-sky-500/30 rounded-xl flex items-center justify-center mb-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" strokeWidth="2.5" />
              </svg>
            </div>
            <h3 className="text-xs font-black text-white uppercase tracking-wider">
              Paket Lengkap
          ...
          {/* CS Siaga */}
          <div className="bg-white/[0.08] rounded-2xl p-4 border border-white/12 shadow-sm">
            <div className="w-9 h-9 bg-rose-500/20 text-rose-400 border border-rose-500/30 rounded-xl flex items-center justify-center mb-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
        ...
        <div className="pt-6 border-t border-white/10 flex flex-col items-center">
          ...
          <Link
            href="/admin"
            className="flex items-center gap-1.5 px-5 py-2.5 bg-white/5 hover:bg-white/10 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition duration-300 active:scale-95 border border-white/10 shadow-sm"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
