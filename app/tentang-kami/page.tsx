  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#0b0f19] pb-10 transition-colors duration-500">
      ...
      <div className="px-5 mt-6 space-y-6">
        ...
        {/* Profile Card */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-100 dark:border-slate-800/80 shadow-sm relative overflow-hidden transition-colors duration-500">
          <div className="absolute top-0 right-0 w-32 h-32 bg-orange-500/5 dark:bg-emerald-500/5 rounded-full blur-2xl -mr-8 -mt-8" />
          
          <h2 className="text-base font-black text-slate-800 dark:text-white uppercase tracking-wider mb-2">
            Arwani D'Gabriel Store
          </h2>
          <p className="text-xs text-orange-500 dark:text-emerald-400 font-extrabold uppercase tracking-widest mb-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800/80 shadow-sm transition-colors duration-500">
            <div className="w-9 h-9 bg-orange-50 dark:bg-orange-950/20 rounded-xl flex items-center justify-center text-orange-500 dark:text-orange-400 mb-3">
          ...
          {/* Lengkap */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800/80 shadow-sm transition-colors duration-500">
            <div className="w-9 h-9 bg-indigo-50 dark:bg-indigo-950/20 rounded-xl flex items-center justify-center text-indigo-500 dark:text-indigo-400 mb-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
          ...
          {/* CS Siaga */}
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800/80 shadow-sm transition-colors duration-500">
            <div className="w-9 h-9 bg-purple-50 dark:bg-purple-950/20 rounded-xl flex items-center justify-center text-purple-500 dark:text-purple-400 mb-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
        ...
        <div className="pt-6 border-t border-slate-200 dark:border-slate-850 flex flex-col items-center">
          ...
          <Link
            href="/admin"
            className="flex items-center gap-1.5 px-5 py-2.5 bg-slate-200 hover:bg-slate-300 dark:bg-slate-900 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 text-[10px] font-black uppercase tracking-widest rounded-xl transition duration-300 active:scale-95 border border-slate-100 dark:border-slate-800 shadow-sm"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
