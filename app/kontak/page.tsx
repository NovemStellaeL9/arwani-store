  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#081225] pb-10">
      ...
      <div className="px-5 mt-6 space-y-6">
        ...
        {/* Contact info list */}
        <div className="bg-white/[0.08] backdrop-blur-md rounded-3xl p-6 border border-white/12 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-2xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 flex items-center justify-center flex-shrink-0 shadow-inner">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-xs font-extrabold text-blue-400 hover:underline mt-0.5 block"
                >
                  +62 859-6709-6912
                </a>
            ...
            {/* Jam Operasional */}
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-2xl bg-blue-500/20 text-blue-400 border border-blue-500/30 flex items-center justify-center flex-shrink-0 shadow-inner">
            ...
            {/* Email */}
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-2xl bg-sky-500/20 text-sky-400 border border-sky-500/30 flex items-center justify-center flex-shrink-0 shadow-inner">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
        ...
        <div className="text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl text-xs font-black uppercase tracking-widest text-center block shadow-md hover:shadow-lg transition duration-300 hover:-translate-y-0.5 active:scale-98"
          >
