  ...
  return (
    <div className="flex flex-col min-h-screen bg-app-bg pb-10 transition-colors duration-500">
      ...
      <div className="px-5 mt-6 space-y-6">
        ...
        {/* Contact info list */}
        <div className="bg-app-card rounded-3xl p-6 border border-app-border shadow-sm space-y-6 transition-colors duration-500">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-2xl bg-app-success-light text-app-success flex items-center justify-center flex-shrink-0">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-xs font-extrabold text-app-primary hover:underline mt-0.5 block"
                >
                  +62 859-6709-6912
                </a>
            ...
            {/* Jam Operasional */}
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-2xl bg-app-primary-light text-app-primary flex items-center justify-center flex-shrink-0">
            ...
            {/* Email */}
            <div className="flex items-start gap-3.5">
              <div className="w-10 h-10 rounded-2xl bg-app-info-light text-app-info flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
