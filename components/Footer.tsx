...
export default function Footer() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full max-w-md mx-auto backdrop-blur-xl bg-[#081225]/85 border-t border-white/8 rounded-t-[2rem] shadow-[0_-10px_35px_-12px_rgba(0,0,0,0.5)] px-4 py-2 flex justify-between items-end z-40 h-[4.75rem] transition-all duration-300">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 -top-5 flex flex-col items-center z-50">
        <a
          ...
          className="bg-emerald-500 w-13 h-13 rounded-full flex items-center justify-center border-4 border-[#081225] hover:scale-110 hover:shadow-[0_8px_25px_rgba(16,185,129,0.5)] active:scale-95 transition-all duration-300 shadow-[0_4px_16px_rgba(16,185,129,0.35)]"
        >
        ...
        <span className="text-[9px] font-black mt-1 text-emerald-400 drop-shadow-sm uppercase tracking-widest">
          CS Admin
        </span>
      </div>
